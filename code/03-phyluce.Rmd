...
sanity check: shouldn't have more hits than their are in the bait files:

```{bash}
head ../data/phyluce/Baits_Bivalve_v1.fasta
echo "Number of Sequences"
grep -c ">" ../data/phyluce/Baits_Bivalve_v1.fasta
```

```{bash}
head ../data/phyluce/Baits_Bivalve_v2.fasta
echo "Number of Sequences"
grep -c ">" ../data/phyluce/Baits_Bivalve_v2.fasta
```
