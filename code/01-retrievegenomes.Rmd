...
### downloading outgroup files for tree building

only three genomes being downloaded so just enter manually into loop
...
# only three genomes being downloaded so just enter manually into loop
accessions="GCF_003073045.1 GCF_000002075.1 GCF_000327385.1"
...
unzip("../data/genomes_refseq/GCF_003073045.1_cds.zip", exdir = "../data/genomes_refseq/")

unzip("../data/genomes_refseq/GCF_000002075.1_cds.zip", exdir = "../data/genomes_refseq/")
