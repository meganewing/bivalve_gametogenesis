...
> ../output/blastout/GCF_963853765.1_with_headers_sep.tab

head -3 ../output/blastout/GCF_963853765.1_with_headers_sep.tab
```

```{r}

SPID <- read.csv("../output/blastout/GCF_963853765.1_with_headers_sep.tab", sep = "", header = F)
head(SPID)
