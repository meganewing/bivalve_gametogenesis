...
```{bash}
head ../data/genomes_refseq/ncbi_dataset/data/GCF_963853765.1/cds_from_genomic.fna
echo "Number of Sequences"
grep ">" -c ../data/genomes_refseq/ncbi_dataset/data/GCF_963853765.1/cds_from_genomic.fna
```

```{bash}
echo "Total length in Gbp"
grep -v ">" ../data/genomes_refseq/ncbi_dataset/data/GCF_963853765.1/cds_from_genomic.fna | \
tr -d '\n' | wc -c | awk '{printf "%.3f\n", $1/1e9}'
```
...
temp <- read.csv("../output/GCF_963853765.1_annotation.tab")
```
